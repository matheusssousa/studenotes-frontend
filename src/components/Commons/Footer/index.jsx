...
export default function Footer(params) {
    ...
    return (
        <footer className="border-t border-neutro-300 border-opacity-20 flex justify-between items-center flex-col md:flex-row py-3 px-1 md:px-2 text-neutro-600">
