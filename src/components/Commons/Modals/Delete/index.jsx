...
export default function ModalDelete(params) {
    return (
        <div className="modal-overlay">
            <div className="modal">
                <p className="title-modal dark:text-neutro-100">Excluir {params.item.nome}</p>
                <p className="text-modal dark:text-neutro-100">Tem certeza que deseja excluir {params.item.nome}?</p>
