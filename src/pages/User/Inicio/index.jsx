...
export default function InicioUserPage() {
    return (
        <div className="page-body flex bg-neutro-100 flex-col sm:flex-row">
            <div className="w-full md:w-1/2 xl:w-1/2 h-screen bg-neutro-600 flex items-center justify-center md:rounded-br-[90%] flex-col">
                <img src={ArtLogin} alt="Logo" className="w-[80%] select-none" />
            </div>
            <div className="w-full md:w-1/2 xl:w-1/2 h-screen flex justify-center items-center flex-col gap-8 bg-cinzaClaro p-3">
